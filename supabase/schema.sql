-- ============================================================
-- OLLIN Database Schema (v2.1 — matches the app as it is today)
-- Run this whole file in: Supabase Dashboard → SQL Editor → New query
-- Safe to re-run: tables are created if missing, policies replaced.
--
-- ORDER MATTERS: Postgres validates SQL function bodies at creation
-- time, so ALL tables are created before the helper functions and
-- row-level-security policies that reference them.
-- ============================================================
...
-- ============================================================
-- 2. HELPER FUNCTIONS (all tables exist by now)
-- ============================================================
...
-- (admin-created users included). role/year can be passed in metadata.
